...
/*-------------------------------------------------------------------------------------
  ...
  Sample run of the program:
	Enter T for true or F for false to indicate if boards and instructions will be displayed: t
	Author: Dale Reed                    
	...
	1. List: 1
	   Robots: 238 255 189 95
	   Enter robot to move and direction (e.g. 2 r), x to exit or b to backup: 1d
	...
	2. List: 2->1
	   Robots: 254 255 189 95
	   Enter robot to move and direction (e.g. 2 r), x to exit or b to backup: 2u
	...
	3. List: 3->2->1
	   Robots: 254 175 189 95
	   Enter robot to move and direction (e.g. 2 r), x to exit or b to backup: b
	* Undoing move * 
	  ---------------------------------------------------------------- 
	 | .   .   .   .   . | .   .   .   .   .   . | .   .   .   .   .  |
	 |                                                                |
...
bool showBoardOrNot; 			// if it should show the board and instructions or not
...
//-------------------------------------------------------------------------------------
// Asks if it should display board or not
//
void ifDisplayOrNot()
{
	...
	if(input == 'F')
	{
		showBoardOrNot = false;
	}else
	{
		cout << endl << "wrong input, running default settings. i.e. will show board and instructions." << endl;
		showBoardOrNot = true;
	}
}
...
class  Node {
	public:
		...
		void addNodeToList(Node *&pHead, Board newBoard, int moveCount)
		{
			Node *pTemp = new Node;
		    pTemp->theBoard = newBoard;
		    pTemp->moveNumber = moveCount;
		    pTemp->pNext = pHead;
		    pHead = pTemp;
		}
...
int main()
{
    ...
    Node *pHead = NULL;
    pHead->addNodeToList(pHead, theBoard, moveNumber);
    // infinite loop to play the game
    while( true) {
    	cout << moveNumber << ". List: " << moveNumber;
		...
		cout << endl;
		cout << "   Robots: " << theBoard.getRobotAt(1) << " " << theBoard.getRobotAt(2) << " " << theBoard.getRobotAt(3) << " " << theBoard.getRobotAt(4) << endl; 
